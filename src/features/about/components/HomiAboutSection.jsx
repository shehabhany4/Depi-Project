...
export default function HomiAboutSection() {
  ...
  return (
    ...
    >
      ...
      {/* ✅ نفس نمط الحاوية بتاع AboutIntro بالظبط (w-[92%] max-w-7xl mx-auto
          من غير px إضافي) عشان يتطابق المحتوى جانبيًا مع باقي سكاشن الصفحة */}
      <div className="mx-auto w-[92%] max-w-7xl py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          {/* Left: Text Content */}
          <motion.div
            initial={{ opacity: 0, x: -40 }}
